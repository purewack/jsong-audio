...
test('common 6/8 time',()=>{
    expect(beatTransportDelta('1:2:0','2:1:0',[6,8])).toBe(2)
    expect(beatTransportDelta('1:2:2.3','2:1:0',[6,8])).toBe(2)
...
test('complex 7/8 time',()=>{
    expect(beatTransportDelta('1:0:0','2:0:0',[7,8])).toBe(3.5)
    expect(beatTransportDelta('1:1:2.3','2:0:0',[7,8])).toBe(2.5)
    expect(beatTransportDelta('1:0:1','2:1:0',[7,8])).toBe(4.5)
